...
#ifndef __Sunset_Phy_Urick_h__
#define __Sunset_Phy_Urick_h__
...
/*! @brief This class extends the UnderwaterMPhyBpsk ("Urick" model) class of WOSS (or ns-miracle, if avaible) enabling the usage of several transmission powers and energy consumption models.
 */

class Sunset_Phy_Urick: public UnderwaterMPhyBpsk, public Sunset_Module {
