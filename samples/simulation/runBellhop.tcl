...
if {$params(bellhop) == 1} {
	if { $params(use_db) == 1 } {
		source "./tcl_folder/WossFileWithDb.tcl"
	} else {
		source "./tcl_folder/WossFileWithoutDb.tcl"
	}
}
...
proc createSink { } {
	...
	set phy($params(sink)) 		[new "WOSS/Module/MPhy/BPSK"]
