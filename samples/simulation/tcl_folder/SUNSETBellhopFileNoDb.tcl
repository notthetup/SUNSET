...
Module/Sunset_Phy_Bellhop  set AcquisitionThreshold_dB_   $params(detectionDB)
Module/Sunset_Phy_Bellhop  set BitRate_                   $params(bitrate)
Module/Sunset_Phy_Bellhop  set MaxTxSPL_dB_               $params(txPower)
Module/Sunset_Phy_Bellhop  set MaxTxRange_                $params(txRadius)
Module/Sunset_Phy_Bellhop  set MinTxSPL_dB_               10
Module/Sunset_Phy_Bellhop  set MaxTxRange_                $params(txRadius)
Module/Sunset_Phy_Bellhop  set PER_target_                0.1
Module/Sunset_Phy_Bellhop  set TxSPLMargin_dB_            10
Module/Sunset_Phy_Bellhop  set RxSnrPenalty_dB_           -10.0
