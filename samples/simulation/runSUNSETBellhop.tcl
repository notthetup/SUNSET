...
#	+------------------------------------+
#
# Five Nodes are in the network. Sink is node 1, other nodes generate 
# CBR traffic to the sink.
...
proc createSink { } {
	...
	for { set id 1} {$id <= $params(numNodes)} {incr id} {
		$node_($params(sink)) addModule 6 $cbr_sink_($id) 0 "CBR"
	}     
...
proc startModule { } {
	...
	global ns  params time START_DELAY  source_  routing_ mac_ statistics info_dispatcher energy phy  statistics
