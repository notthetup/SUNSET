...
#STRING TOPOLOGY
proc createBlacklistString { id } {
	
	global params phy

	if { $id == 1 } {
		$phy($id) addToBlacklist 2
		$phy($id) addToBlacklist 3
		$phy($id) addToBlacklist 4
	}
