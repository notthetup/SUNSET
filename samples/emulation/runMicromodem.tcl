...
#MICRO-MODEM
set params(mm)			1
set params(mm_ascii)		0
set params(mm_hex)		1
set params(mm_serial)		"/dev/ttyS1"	;# serial line the Micro-Modem is connected to
set params(mm_baudRate)		19200
set params(mm_gps)		0
set params(mm_rate)		0
set params(mm_miniPkt)		1
set params(mm_modemAck)		0
set params(mm_agn)		250
set params(mm_cto)		30
set params(mm_bitrate)		80
set params(mm_data_bitrate)	80
set params(mm_ctrl_bitrate)	80
set params(mm_max_pkt_size)	32

#MODEM DELAY
set params(mm_delay)			2.8
set params(mm_data_delay)		2.8
set params(mm_ctrl_delay)		1

set params(bitrate)  	      	$params(mm_bitrate)
...
load $pathSUNSET/libSunset_Emulation_Micro_Modem.so.0.0.0 
...
Sunset_MicroModem set debug_ false
...
Sunset_Timing_Emulation set modemDelay_			$params(mm_delay)
Sunset_Timing_Emulation set modemDelayCtrl_		$params(mm_ctrl_delay)
Sunset_Timing_Emulation set modemDelayData_		$params(mm_data_delay)

Sunset_Timing_Emulation set dataRate_			$params(dataRate)
Sunset_Timing_Emulation set ctrlRate_			$params(ctrlRate)
Sunset_Timing_Emulation set baudRate_			$params(mm_baudRate)
...
proc createNodeEmulation {id } {
	...
	set modem [new Sunset_MicroModem]
	...
	$modem setSerial 		$params(mm_serial)
	$modem setBaud 			$params(mm_baudRate)
	$modem set USE_ASCII_ 		$params(mm_ascii)
	$modem set USE_HEX_ 		$params(mm_hex)
	$modem set USE_ACK_ 		$params(mm_modemAck)
	$modem set MODEM_RATE_ 		$params(mm_rate)
	$modem set USE_GPS_INFO_ 	$params(mm_gps)
