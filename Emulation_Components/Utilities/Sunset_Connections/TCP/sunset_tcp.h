...
#ifndef __Sunset_Tcp_Connection_h__
#define __Sunset_Tcp_Connection_h__
...
#define SUNSET_TCP_MAX_IP_LEN		16
#define SUNSET_TCP_MAX_BUF_SIZE		32768


/*! \brief The generic TCP connections class */

class Sunset_Tcp_Connection : public Sunset_Connection {
	
public:
	
	Sunset_Tcp_Connection(const char *, int);
	~Sunset_Tcp_Connection();
